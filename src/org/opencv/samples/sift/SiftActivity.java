...
public class SiftActivity extends Activity implements CvCameraViewListener2 {
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        ...
        switch (SiftActivity.viewMode) {
        case SiftActivity.VIEW_MODE_RGBA:
            break;

        case SiftActivity.VIEW_MODE_HIST:
            Mat hist = new Mat();
        ...
        case SiftActivity.VIEW_MODE_CANNY:
        ...
        case SiftActivity.VIEW_MODE_SOBEL:
        ...
        case SiftActivity.VIEW_MODE_SEPIA:
            rgbaInnerWindow = rgba.submat(top, top + height, left, left + width);
            Core.transform(rgbaInnerWindow, rgbaInnerWindow, mSepiaKernel);
            rgbaInnerWindow.release();
            break;

        case SiftActivity.VIEW_MODE_ZOOM:
        ...
        case SiftActivity.VIEW_MODE_PIXELIZE:
            rgbaInnerWindow = rgba.submat(top, top + height, left, left + width);
        ...
        case SiftActivity.VIEW_MODE_POSTERIZE:
            /*
